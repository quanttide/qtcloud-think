...
const List<JournalEntry> journalEntries = [
  JournalEntry(
    id: 'para-1',
  ...
  JournalEntry(
    id: 'para-2',
    content: '原始的日志整理加工后具备去看真实的思考过程和情感过程。这些是非常丰富的元素材。同时，这也是AI原生时代的一个原方法。',
    highlights: [],
  ),
  JournalEntry(
    id: 'para-3',
  ...
  JournalEntry(
    id: 'para-8',
    content: '我从知识工程角度来看的话，其实我们对资产做的���一系列活动，很大程度上就是知识工程的流程。范畴论就很有 summarize 的这种感觉在。',
    highlights: [
